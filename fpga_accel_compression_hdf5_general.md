...
Implements the standard [DEFLATE algorithm]() and is a drop-in
...
## Ohter compression tools/algorithms (software implementations).

[lz4](https://github.com/lz4/lz4), especially the [benchmarks table
from its README](https://github.com/lz4/lz4#benchmarks).

Very quick comparison with easily-compressible HDF5 files on my
virtual machine (osboxes Ubuntu 16.04):
